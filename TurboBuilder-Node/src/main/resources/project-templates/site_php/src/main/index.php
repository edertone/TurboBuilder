...
require 'phar://libs/turbosite-php/turbosite-php-6.0.0.phar/php/autoloader-project.php';
require 'libs/turbocommons-php/turbocommons-php-3.1.0.phar';
require 'libs/turbodepot-php/turbodepot-php-6.2.0.phar';
require 'libs/turbosite-php/turbosite-php-6.0.0.phar';
