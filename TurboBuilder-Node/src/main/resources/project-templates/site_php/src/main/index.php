...
require 'phar://libs/turbosite-php/turbosite-php-9.0.0.phar/php/autoloader-project.php';
require 'libs/turbocommons-php/turbocommons-php-3.8.0.phar';
require 'libs/turbodepot-php/turbodepot-php-7.2.0.phar';
require 'libs/turbosite-php/turbosite-php-9.0.0.phar';
